            ...
            while ( $faqs_query->have_posts() ) :
                ...
                <div class="qe-faq-toggle">
                    <div class="qe-toggle-title">
                        <strong> <?php the_title(); ?><i class="fa fa-angle-down"></i></strong>
                    </div>
        ...
        if ( ! empty( $faq_groups ) && ! is_wp_error( $faq_groups ) ) {
            ...
            foreach ( $faq_groups as $faq_group ) {
                ...
                if ( empty( $filter_array ) || in_array ( $faq_group->slug , $filter_array ) ) {
                    ...
                    if ( $faqs_query->have_posts() ) :
                        echo '<h4>' . $faq_group->name . '</h4>';
                        echo '<div class="qe-faqs-toggles-group1">';
                        while ( $faqs_query->have_posts() ) :
                            $faqs_query->the_post();
                            ?>
                            <div class="qe-faq-toggle1">
                                <div class="qe-toggle-title1">
                                    <div class="strong-faq"><?php the_title(); ?></div><div class="img-angle"><div class="hier angle-down"></div></div>
                                </div>
                                <div class="qe-toggle-content1" style="display: none;">
                                    <?php the_content(); ?>
                                </div>
                            </div>
                            <?php
