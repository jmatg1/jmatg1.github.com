...
Having a responsive FAQ page is a necessity for most of the websites and this advanced WordPress plugin is the easiest way to add unlimited questions and categories.

Using this plugin you can create unlimited amount of questions and answers. The free FAQ plugin will allow you to assign questions and answers into categories. The accordion view will allow displaying only the questions thus saving space and allowing the user to navigate to the relevant question. To make the question search even more user -friendlier, it is possible to display a FAQ-specific search box. 
...
The categories of questions can have descriptions. The details about the categories will be possible to insert with the FAQs. In case of having multiple categories (if the titles are displayed), the questions will be separated into tabs. You can also skip displaying category details and titles, thus the questions will be listed below each other based on the category order provided in Order section.

Upgrade to [Paid version](https://web-dorado.com/products/wordpress-faq-wd.html) to add features: 
...
= How can I create and manage a category? =
...
= Is it possible to edit the appearance of FAQs? =

Paid version of WordPress FAQ WD plugin provides Themes Options. In this section of the plugin you can make changes to the default themes add create new themes (commercial version).
...
= Can I modify the settings of the plugin? =
...
= How can I publish the FAQs on pages or posts? =

Follow the instruction to include the FAQ lists in a post/page using FAQ shortcode.

Go to the Page/Post, where you want to add the FAQ, click on the FAQ icon (question mark) within the standard editor, a pop-up will open up, where you can set the FAQ options.
...
= 1.0.36 =
Fixed: Frontend styles and scripts are loaded only with plugin content   
...
= 1.0.33 = 
Fixed: Paid version link  

= 1.0.32 = 
Fixed: PHP notices in deactivation popup  

= 1.0.31 = 
Changed: Introducing brand new FREE Backup WD plugin  

= 1.0.30 = 
Fixed: Network activation issue  
