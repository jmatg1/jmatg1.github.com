...
Donate link: http://rich-web.esy.es/tabs
Tags: tab, accordion, wordpress tab, responsive tabs, tabs plugin
...
[Tabs or Accordion Pro Key Features](http://rich-web.esy.es/tabs), which gives you additional features such as.
...
[Here you can see a demo of all types of tabs](http://rich-web.esy.es/wordpress-bar-tab-horizontal/)
[Here you can see the demo of all types of accordion](http://rich-web.esy.es/wordpress-tab-accordion-faq-1)
...
1.  Create your tab using the plugin.
...
3.  That ' s it! Your ?????? will work out of the box instantly.
...
### IMPORTANT:
If You think You have found a mistake in the plugin or have any problems, questions about the plugin, please read the [Support Forum](https://wordpress.org/support/plugin/tabbed) ?r can you ask your question on our WordPress website. If You can not find a solution here, please feel free and click here to [Contact US](http://rich-web.esy.es/contact-us).
