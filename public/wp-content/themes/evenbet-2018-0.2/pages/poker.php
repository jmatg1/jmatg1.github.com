...
<?php get_template_part( 'parts/sub-header-poker');?>

<section class="poker">
    <div class="container">
        <div class="wrapper-poker">
            <div class="poker-page-descr">
                <?= do_shortcode( '[acf field="poker_unit-boby_poker"]' );?>   
            </div>
            <!-- /.poker-page-descr -->
            <div class="poker-page-title">
                <?= do_shortcode( '[acf field="poker_unit-title_advantages"]' );?> 
            </div>
            <!-- /.poker-page-title -->
            ...
            <div id="features">
                <div id="features-title" class="poker-page-title">
                    <?= do_shortcode( '[acf field="poker_unit-title_features"]' );?>
                </div>
                <div class="img-angle"><div class="hier angle-down"></div></div>
            </div>

            <div id="features-desc" class="poker-page-descr" >
                <?= do_shortcode( '[acf field="poker_unit-features_description"]' );?>
            </div>
            <div id="features-list" style="display: none;">
                <?= do_shortcode( '[acf field="poker_unit-features_list"]' );?>
            </div>
            <div class="poker-page-title">
                <?= do_shortcode( '[acf field="poker_unit-title_product-package"]' );?> 
            </div>
            <!-- /.poker-page-title -->
            <div class="poker-page-descr">
                <?= do_shortcode( '[acf field="poker_unit-boby_product-package"]' );?> 
            </div>
            <!-- /.poker-page-descr -->
            <ul class="product-package-list">
                <li class="product-package-item">
                    ...
                    <div class="product-package-item-textinfo">
                        <div class="product-package-item-textinfo-title">
                            <?= do_shortcode( '[acf field="poker_unit-title_server"]' );?>
                        </div>
                        <!-- /.product-package-item-textinfo-title -->
                        <div class="product-package-item-textinfo-descr">
                            <?= do_shortcode( '[acf field="poker_unit-boby_server"]' );?>                            
                        </div>
                ...
                <li class="product-package-item">
                    ...
                    <div class="product-package-item-textinfo">
                        <div class="product-package-item-textinfo-title">
                            <?= do_shortcode( '[acf field="poker_unit-title_clien-application"]' );?>
                        </div>
                        <!-- /.product-package-item-textinfo-title -->
                        <div class="product-package-item-textinfo-descr">
                            <?= do_shortcode( '[acf field="poker_unit-boby_client-application"]' );?>
                        </div>
                        <!-- /.product-package-item-textinfo-descr -->
                    </div>
                    <!-- /.product-package-item-textinfo -->
                ...
                <li class="product-package-item">
                    ...
                    <div class="product-package-item-textinfo">
                        <div class="product-package-item-textinfo-title">
                            <?= do_shortcode( '[acf field="poker_unit-title_control-module"]' );?>
                        </div>
                        <!-- /.product-package-item-textinfo-title -->
                        <div class="product-package-item-textinfo-descr">
                            <?= do_shortcode( '[acf field="poker_unit-boby_control-module"]' );?>
                        </div>
                        <!-- /.product-package-item-textinfo-descr -->
                    </div>
                    <!-- /.product-package-item-textinfo -->
                ...
                <li class="product-package-item">
                    ...
                    <div class="product-package-item-textinfo">
                        <div class="product-package-item-textinfo-title">
                            <?= do_shortcode( '[acf field="poker_unit-title_support"]' );?>
                        </div>
                        <!-- /.product-package-item-textinfo-title -->
                        <div class="product-package-item-textinfo-descr">
                            <?= do_shortcode( '[acf field="poker_unit-boby_support"]' );?>
                        </div>
                        <!-- /.product-package-item-textinfo-descr -->
                    </div>
                    <!-- /.product-package-item-textinfo -->
    ...
    <div class="container">
        <div class="wrapper-poker">
            <div class="poker-page-title">
                <?= do_shortcode( '[acf field="poker_unit-title_demo-version"]' );?> 
            </div>
            <!-- /.poker-page-title -->
            <ul class="demo">
                <li class="demo-item">
                    ...
                    <div class="demo-item-textinfo">
                        ...
                        <div class="demo-item-textinfo__buttons-part">
                            <button class="button poker-button-first try-demo-button">Try on</button>
                ...
                <li class="demo-item">
                    ...
                    <div class="demo-item-textinfo">
                        ...
                        <!-- /.demo-item-textinfo__descr -->
                        <div class="demo-item-textinfo__buttons-part">
                            <button class="button poker-button-first try-demo-button">Try on IOS</button>
            ...
            <!-- /.demo -->
            <div class="poker-page-descr">
            <?= do_shortcode( '[acf field="poker_unit-boby_demo-version"]' );?>   
            </div>
            <!-- /.poker-page-descr -->
        </div>
        <!-- /.wrapper-poker -->
    ...
    <div class="slider-3">
        <div id="swiper-container-3" class="swiper-container gallery-top">
            <div class="swiper-wrapper">
                ...
                <?= do_shortcode('[pods name="poker_slides" template="Template for product slides"]'); ?>
    ...
    <div class="container">
        <div class="wrapper-poker">
            <div class="poker-page-descr">
                <?= do_shortcode( '[acf field="poker_unit-boby_demo-version-2"]' );?>
            </div>
            <!-- /.fantasy-page-descr -->
            <div class="video-youtube">
                <?  $link= do_shortcode('[acf field="poker_unit-link-youtube"]');
                if ( isset($link) ) {
    ...
    <div class="container">
        <div class="wrapper-poker">
            <div class="poker-page-title">
                <?= do_shortcode( '[acf field="poker_unit-title_our-projects"]' );?> 
            </div>
            <!-- /.poker-page-title -->
        </div>
        <!-- /.wrapper-poker -->
